...
<html lang='en'>
  <head>
    <title>
      Guthrie Muscovitch Architects - Services
    </title>
    <meta charset='utf-8'>
  ...
  <body class='services'>
    ...
    <section class='interior-page-header services'>
      <div class='wrapper'>
        <h1>
    ...
    <div class='keyline'></div>
    <section class='interior-page services'>
      <div class='wrapper'>
        <div class='left'>
          <h4>
            Architectural
          ...
          <p>
            <?php perch_content('content-architectural')?>
          </p>
        </div>
        <div class='right'>
          <h4>
          ...
          <p>
            <?php perch_content('content-urban')?>
          </p>
        </div>
      </div>
      <div class='clear'></div>
